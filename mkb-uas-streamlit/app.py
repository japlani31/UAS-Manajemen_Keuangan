# -*- coding: utf-8 -*-
"""
UAS Manajemen Keuangan Bisnis - Universitas Muhammadiyah Metro
Ardiansyah Japlani, S.E., M.B.A. - FEB UM Metro.

Aplikasi fokus tunggal: Ujian Akhir Semester Manajemen Keuangan Bisnis dengan pengaman anti-contek,
...
st.set_page_config(page_title="UAS Manajemen Keuangan Bisnis - UM Metro",
...
def buat_kartu_hasil(nama, npm, nilai, benar, total, waktu_str):
    ...
    d.text((24, 20), "BUKTI PENGERJAAN UAS MANAJEMEN KEUANGAN BISNIS", font=font(20, True), fill="white")
...
# ============================================================
def halaman_uas():
    st.header("🎓 Ujian Akhir Semester (UAS) Manajemen Keuangan Bisnis")
    _mesin_ujian(
        judul="UAS",
        jenis="uas",
